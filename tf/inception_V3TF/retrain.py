...
def add_final_training_ops(class_count, final_tensor_name, bottleneck_tensor):
  ...
  with tf.name_scope(layer_name):
    ...
    with tf.name_scope('Wx_plus_b'):
      ...
      #logits = np.random.uniform(low=0.75, high=1.5, size=logits.shape() )
...
def main(FLAGS):
  ...
  #maybe_download_and_extract() #uncomment to download model
...
def retrain(image_dir, output_dir, summary_dir, model_dir ):
  #parser = argparse.ArgumentParser()
  parser.add_argument(
      '--image_dir',
      type=str,
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default=output_dir+'/output_graph.pbtxt',
